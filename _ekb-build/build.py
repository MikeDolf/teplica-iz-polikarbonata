...
def render_hub(all_pages):
    ...
    about = [
        ...
        "Работаем по Екатеринбургу и области примерно до 100 километров от базы. Баз у нас три, отгружаем с той, где лежит нужный материал: чернозём, торф и торфогрунт из Курганово, перегной и навоз из Садового. По городу и ближнему пригороду чаще всего успеваем в день заказа, в дальние города планируем на ближайшие дни. Материал и доставка считаются отдельно: доставка от 76 ₽ за километр, рейс туда и обратно, поэтому чем больше объём в кузове, тем дешевле выходит куб. Точную цену называем сразу по заявке, оплата после выгрузки.",
    ]
    faq = [
