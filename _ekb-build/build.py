...
def render_hub(all_pages):
    ...
    faq = [
        ...
        ("В каком объёме возите?", "Навалом: небольшая машина берёт до 4 кубов, КамАЗ до 10, самосвал до 26 кубов за рейс. Минимальный заказ по Екатеринбургу и северному кусту — один куб, в остальные города — три. Есть и фасовка: готовый почвогрунт, универсальная смесь, фрезерованный торф и опил в мешках, от 5 мешков. Скажите объём и адрес, подскажем, какая машина выгоднее."),
