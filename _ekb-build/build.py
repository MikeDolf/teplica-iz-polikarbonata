...
def render_hub(all_pages):
    ...
    html = env.get_template("hub.html").render(
        ...
        description="Доставка чернозёма, перегноя и навоза по Екатеринбургу и Свердловской области. Минимальный заказ 3 м³, возим навалом самосвалом. Доставка от 76 ₽/км, рейс считает калькулятор.",
