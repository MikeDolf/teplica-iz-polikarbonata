...
CROSSLINK = {
    ...
    "peregnoy-ekaterinburg": {"title":"Искали перегной в мешках?","text":"Чистый перегной в мешки мы не фасуем, но есть готовая универсальная смесь с перегноем в составе: мешок 50 литров, 550 рублей, от 5 мешков. Сам перегной возим навалом, минимальный заказ по Екатеринбургу — один куб, и на отдельной странице разобрано, сколько это в мешках, во что обходится куб против фасовки в магазине и как разгрузиться, если самосвалу негде встать.","url":"/peregnoy-v-meshkah-ekaterinburg/","anchor":"Перегной в мешках: что есть и что навалом"},
...
def render_hub(all_pages):
    ...
    faq = [
        ...
        ("В каком объёме возите?", "Навалом: небольшая машина берёт до 4 кубов, КамАЗ до 10, самосвал с наращенными бортами до 26 кубов за рейс. Минимальный заказ по Екатеринбургу и северному кусту — один куб, в остальные города — три. Есть и фасовка: готовый почвогрунт, универсальная смесь, фрезерованный торф и опил в мешках, от 5 мешков. Скажите объём и адрес, подскажем, какая машина выгоднее."),
