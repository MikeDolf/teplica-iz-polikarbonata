...
CROSSLINK = {
    ...
    # Страница фасованного опила ведёт не на опил навалом (его нет), а на
    # замену под большой объём. Своя запись нужна ей ещё и затем, чтобы она
    # не провалилась в CROSSLINK_BY_PRODUCT и не сослалась сама на себя.
    "opilki-v-meshkah-ekaterinburg": {"title":"Нужен объём больше, чем несколько мешков?","text":"Под мульчу на большую площадь опил мешками брать невыгодно: навалом его у нас нет, а десятки мешков стоят дороже машины. Ту же задачу закрывает перегной слоем 5-8 сантиметров, и он, в отличие от свежего опила, не тянет из почвы азот.","url":"/peregnoy-ekaterinburg/","anchor":"Перегной навалом, цена за куб"},
}
...
CROSSLINK_BY_PRODUCT = {
    "opilki": {"title":"Опил в мешках у нас есть","text":"Навалом опила по-прежнему нет, а вот в мешках он появился: мелкий и крупный, мешок 50 литров, 450 рублей, минимальный заказ 5 мешков. Мелкий берут под мульчу, крупный на подстилку животным. Везём с площадки в районе Верхней Пышмы.","url":"/opilki-v-meshkah-ekaterinburg/","anchor":"Опил в мешках, 450 ₽ за мешок"},
}
