...
def build():
    ...
    put(r, 1, "Чернозём, перегной и навоз возим только навалом. В мешках — "
              "почвогрунт, универсальная смесь, фрезерованный торф и опил, "
              "от 5 мешков.", bold=True, size=11); r += 2
